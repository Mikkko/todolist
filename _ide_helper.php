 ...
 * Generated for Laravel 6.9.0 on 2020-01-03 00:25:42.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
        ...
        /**
         * Create a session based auth guard.
         *
         * @param string $name
         * @param array $config
        ...
        /**
         * Create a token based auth guard.
         *
         * @param string $name
         * @param array $config
        ...
        /**
         * Set the default auth driver name.
         *
         * @param string $name
         * @return void
         * @static
        ...
        /**
         * Register an auth attempt event listener.
         *
    ...
    class Broadcast {
        ...
        /**
         * Register the routes for handling broadcast auth and sockets.
         *
    ...
    class Request {
         ...
         *
         * If the URL was called with basic auth, the user
    ...
    class Route {
        ...
        /**
         * Register the typical auth routes for an application.
         *
         * @param array $options
         * @return void
         * @static
